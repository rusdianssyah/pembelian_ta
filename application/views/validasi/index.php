...
<div class="wrapper">   
            ...
            <div class="card-header">
              <h3 class="card-title">Data Permintaan Pembelian Spare Part Belum Disetujui</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <?php 
                echo "
                  ".anchor('validasi/tampil_detail/'.$key->id_permintaan,'Detail',array('class'=> 'btn btn-primary')).""
            ?>
                    </td>
                  </tr>
                  <?php endforeach ?>
